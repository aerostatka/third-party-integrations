...
func CreateDeleteAction(rep Repository, st Storage, params *models.OktaToolParameters, log logger.Logger) *DeleteAction {
	return &DeleteAction{
		repository: rep,
		storage:    st,
		parameters: params,
...
func (action *DeleteAction) ApplyAction() *models.ActionResult {
...
func (action *DeleteAction) disableApplications() error {
